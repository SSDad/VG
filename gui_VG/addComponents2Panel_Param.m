...
%% Time range
y0 = y0-h_Gap-h_Time;
Comp.subPanel.TimeRange.hPanel = uipanel('parent', hPanel,...
                                'Unit', 'Normalized',...
...
Comp.subPanel.TimeRange.Edit.Time = uicontrol('parent', Comp.subPanel.TimeRange.hPanel, ...
                                'Style', 'edit',...
                                'Unit', 'Normalized',...
...
Comp.subPanel.TimeRange.Text.s = uicontrol('parent', Comp.subPanel.TimeRange.hPanel, ...
                                'Style', 'text',...
                                'Unit', 'Normalized',...
...
Comp.subPanel.pps.Edit.pps = uicontrol('parent', Comp.subPanel.pps.hPanel, ...
                                'Style', 'edit',...
                                'Unit', 'Normalized',...
                                'Position', [0. 0.05 0.6 0.9],...
                                'FontSize', 10, ...
